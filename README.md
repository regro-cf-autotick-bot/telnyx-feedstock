...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/telnyx-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12310&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/telnyx-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `telnyx` can be installed with:

```
conda install telnyx
```

It is possible to list all of the versions of `telnyx` available on your platform with:
